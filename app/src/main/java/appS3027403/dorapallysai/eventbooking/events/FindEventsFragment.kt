...
import appS3027403.dorapallysai.eventbooking.LoginActivity
            ...
            Image(painter = painterResource(id = R.drawable.baseline_logout_24),
                ...
                modifier = Modifier
                    ...
                    .clickable {
                        ...
                        UserDetails.saveUserLoginStatus(currentActivity, false)
...

        {
            ...
            Column(
                ...
                )
                {
                        Button(
                            onClick = {
                                val intent = Intent(currentActivity, EventDetailsActivity::class.java)
                                currentActivity.startActivity(intent)
                            },
                            modifier = Modifier,
