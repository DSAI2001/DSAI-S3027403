            ...
            onClick = {
                when {
                    ...
                    eventGuestPin.isBlank() -> {
                        eventGuestError = "Better enter your pin"
                    }

                    confirmEventGuestPin.isBlank() -> {
                        eventGuestError = "Better confirm your password"
                    }

                    eventGuestPin != confirmEventGuestPin -> {
                        eventGuestError = "Ouch! Pin seems wrong"
                        ...
                        doesUserExits(eventGuestData, currentActivity)
                    }
                }
...
private fun doesUserExits(userData1: UserData, currentActivity: Activity) {
    ...
    databaseReference.get().addOnCompleteListener { task ->
        if (task.isSuccessful) {
            ...
            if (userData != null) {
                ...
                saveUserData(userData1, currentActivity)
            }
        } else {
...
private fun saveUserData(userData: UserData, currentActivity: Activity) {
